...
public class BuscarClienteF extends javax.swing.JDialog {

    DefaultTableModel modelo;
    Conexion cc= new Conexion();
    Connection cn = cc.conexion();

    public BuscarClienteF(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    try {
        ...
        else
        {
         ...
         frmFactura.txtCodCliente.setText(cod);
         frmFactura.txtSrA.setText(nom+"   "+ape);
         frmFactura.txtDireccion.setText(dir);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarClienteF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarClienteF dialog = new BuscarClienteF(new javax.swing.JFrame(), true);
