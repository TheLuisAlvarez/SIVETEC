...
public class BuscarProductosB extends javax.swing.JDialog {

    Conexion cc = new Conexion();
    Connection cn = cc.conexion();
    DefaultTableModel tabla;

    public BuscarProductosB(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnEnviarDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEnviarDatosMouseClicked
        ...
        DefaultTableModel tabladet = (DefaultTableModel) frmBoleta.tblDetalleBoleta.getModel();
        ...
        if (fila == -1) {
            ...
            if ((cant.equals("")) || (cant.equals("0"))) {
                ...
                if (canting > comp) {
                    ...
                    for (int i = 0; i < frmBoleta.tblDetalleBoleta.getRowCount(); i++) {
                        Object com = frmBoleta.tblDetalleBoleta.getValueAt(i, 0);
                        if (codins.equals(com)) {
                            j = i;
                            frmBoleta.tblDetalleBoleta.setValueAt(cant, i, 3);
                            c = c + 1;
                    ...
                    if (c == 0) {
                        ...
                        frmBoleta.tblDetalleBoleta.setModel(tabladet);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarProductosB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarProductosB dialog = new BuscarProductosB(new javax.swing.JFrame(), true);
